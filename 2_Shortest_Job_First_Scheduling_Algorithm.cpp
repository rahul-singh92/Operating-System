...
int main()
{
    ...
    while(completed_process < size)
    {
        ...
        for(int i = 0;i < size;i++)
        {
            ...
            {
                if(p[i].program_burst_time < min_burst_time || (p[i].program_burst_time == min_burst_time && p[i].program_arrival_time < p[idx].program_arrival_time))
                {
                    min_burst_time = p[i].program_burst_time;
                    idx = i;
                }
            }
        }
