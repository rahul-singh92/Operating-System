...
int main()
{
    ...
    while(completed_process < size)
    {
        ...
        for(int i = 0;i < size;i++)
        {
            ...
            {
                if(p[i].program_burst_time_demo > max_burst_time || (p[i].program_burst_time_demo == max_burst_time && p[i].program_arrival_time < p[idx].program_arrival_time))
                {
                    max_burst_time = p[i].program_burst_time_demo;
                    idx = i;
                }
            }
        }
